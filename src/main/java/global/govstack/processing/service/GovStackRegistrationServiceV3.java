...
/**
 * Version 3 of GovStack Registration Service that saves to multiple forms
 * This version uses configuration-driven mappings for generic service support
 */
public class GovStackRegistrationServiceV3 implements ApiRequestProcessor {
    private static final String CLASS_NAME = GovStackRegistrationServiceV3.class.getName();

    private final String serviceId;
    private final YamlMetadataService metadataService;
    private final ServiceValidator serviceValidator;
    private final GovStackDataMapperV3 dataMapper;
    ...
    public GovStackRegistrationServiceV3(String serviceId) throws ConfigurationException {
        ...
        try {
            ...
            this.dataMapper = new GovStackDataMapperV3(metadataService, dataTransformer);
            ...
            LogUtil.info(CLASS_NAME, "GovStackRegistrationServiceV3 initialized for service: " + serviceId);

        } catch (Exception e) {
            throw new ConfigurationException("Failed to initialize GovStackRegistrationServiceV3: " + e.getMessage(), e);
        }
    }
