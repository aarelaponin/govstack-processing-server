 ...
 */
public class GovStackDataMapperV2 {
    private static final String CLASS_NAME = GovStackDataMapperV2.class.getName();
    private final YamlMetadataService metadataService;
    private final DataTransformer dataTransformer;
    private final ObjectMapper objectMapper = new ObjectMapper();

    // Map YAML sections to actual form IDs
    private static final Map<String, String> SECTION_TO_FORM_MAP = new HashMap<>();
    static {
        SECTION_TO_FORM_MAP.put("farmerBasicInfo", "farmerBasicInfo");
        SECTION_TO_FORM_MAP.put("farmerLocation", "farmerLocation");
        SECTION_TO_FORM_MAP.put("farmerAgriculture", "farmerAgriculture");
        SECTION_TO_FORM_MAP.put("farmerCropsLivestock", "farmerCropsLivestock");
        SECTION_TO_FORM_MAP.put("farmerHousehold", "farmerHousehold");
        SECTION_TO_FORM_MAP.put("farmerIncomePrograms", "farmerIncomePrograms");
        SECTION_TO_FORM_MAP.put("farmerDeclaration", "farmerDeclaration");
    }

    public GovStackDataMapperV2(YamlMetadataService metadataService, DataTransformer dataTransformer) {
        ...
        try {
            ...
            for (Map.Entry<String, Object> entry : allMappings.entrySet()) {
                ...
                if ("array".equals(sectionType)) {
                    ...
                    String formId = SECTION_TO_FORM_MAP.get(sectionName);
                    if (formId == null) {
